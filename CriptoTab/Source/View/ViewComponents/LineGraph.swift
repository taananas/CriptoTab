...
struct LineGraph: View {
    ...
    func FillBG()->some View{
        let color = profit ? Color.green : .red
        LinearGradient(colors: [
...
struct LineGraph_Previews: PreviewProvider {
    static let data: [Double] = [22375.039455087837,22422.125634818287, 22413.812768997555, 22431.198532520255, 22407.2405271634, 22452.125634818287]
